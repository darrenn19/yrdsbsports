#Tier 1 Varsity Girls Slo Pitch Standings
import requests
from bs4 import BeautifulSoup
import json

# URL of the standings page
url = "http://yraa.com/src/standings.php?division=106"
...
if response.status_code == 200:
    ...
    with open("slo-pitch/t1/slopitchstandings.json", "w") as json_file:
        json.dump(json_data, json_file, indent=4)

    print("Data successfully saved to slopitchstandings.json")
else:
