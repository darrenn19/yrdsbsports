#Tier 1 Senior Girls Basketball Standings
import requests
from bs4 import BeautifulSoup
import json

# URL of the standings page
url = "http://yraa.com/src/standings.php?division=48"
...
if response.status_code == 200:
    ...
    with open("basketball/sg/basketballsgstandings.json", "w") as json_file:
        json.dump(json_data, json_file, indent=4)

    print("Data successfully saved to basketballsgstandings.json")
else:
