#Tier 1 Varsity Boys Lacrosse Standings
import requests
from bs4 import BeautifulSoup
import json

# URL of the standings page
url = "http://yraa.com/src/standings.php?division=119"
...
if response.status_code == 200:
    ...
    with open("lacrosse/t1/t1standings.json", "w") as json_file:
        json.dump(json_data, json_file, indent=4)

    print("Data successfully saved to t1standings.json")
else:
