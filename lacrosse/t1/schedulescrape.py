# Tier 1 Varsity Boys Lacrosse Schedule
import requests
...
def scrape_schedule():
    url = "http://yraa.com/src/schedule.php?division=119"  # Schedule over next 7 days
    ...
    # Save JSON
    with open("lacrosse/t1/t1schedule.json", "w", encoding="utf-8") as f:
        json.dump({"schedule": schedule}, f, indent=4, ensure_ascii=False)

    print(f"Saved {len(schedule)} entries to lacrosse/t1/t1schedule.json")
