# Tier 1 Senior Boys Rugby 10's Schedule
import requests
...
def scrape_schedule():
    url = "http://yraa.com/src/schedule.php?division=160"  # Schedule over next 7 days
    ...
    # Save JSON
    with open("rugby-10/sb/sbschedule.json", "w", encoding="utf-8") as f:
        json.dump({"schedule": schedule}, f, indent=4, ensure_ascii=False)

    print(f"Saved {len(schedule)} entries to rugby-10/sb/sbschedule.json")
