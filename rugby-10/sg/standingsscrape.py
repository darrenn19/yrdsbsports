#Tier 1 Senior Girls Rugby 10's Standings
import requests
from bs4 import BeautifulSoup
import json

# URL of the standings page
url = "http://yraa.com/src/standings.php?division=158"
...
if response.status_code == 200:
    ...
    with open("rugby-10/sg/rugbysgstandings.json", "w") as json_file:
        json.dump(json_data, json_file, indent=4)

    print("Data successfully saved to rugbysgstandings.json")
else:
