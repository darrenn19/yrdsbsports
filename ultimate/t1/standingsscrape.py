# Tier 1 Varsity Coed Ultimate Standings
import requests
from bs4 import BeautifulSoup
import json

# URL of the standings page
url = "http://yraa.com/src/standings.php?division=108"
...
if response.status_code == 200:
    ...
    headers = ["Team", "W", "L", "T", "PTS", "SPTS", "PF", "PA"]
    ...
    with open("ultimate/t1/ultimatet1standings.json", "w") as json_file:
        json.dump(json_data, json_file, indent=4)

    print("Data successfully saved to ultimatet1standings.json")
else:
