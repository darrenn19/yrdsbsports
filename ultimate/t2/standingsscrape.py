# Tier 2 Varsity Coed Ultimate Standings
import requests
from bs4 import BeautifulSoup
import json

# URL of the standings page
url = "http://yraa.com/src/standings.php?division=97"
...
if response.status_code == 200:
    ...
    with open("ultimate/t2/ultimatet2standings.json", "w") as json_file:
        json.dump(json_data, json_file, indent=4)

    print("Data successfully saved to ultimatet2standings.json")
else:
