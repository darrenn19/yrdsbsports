# Tier 2 Varsity Coed Ultimate Schedule
import requests
...
def scrape_schedule():
    url = "http://yraa.com/src/schedule.php?division=97"  # Schedule over next 7 days
    ...
    # Save JSON
    with open("ultimate/t2/t2schedule.json", "w", encoding="utf-8") as f:
        json.dump({"schedule": schedule}, f, indent=4, ensure_ascii=False)

    print(f"Saved {len(schedule)} entries to ultimate/t2/t2schedule.json")
