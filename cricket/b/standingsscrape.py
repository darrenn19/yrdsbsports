#Tier 1 Varsity Boys Cricket Standings
import requests
from bs4 import BeautifulSoup
import json

# URL of the standings page
url = "http://yraa.com/src/standings.php?division=64"
...
if response.status_code == 200:
    ...
    with open("cricket/b/cricketstandings.json", "w") as json_file:
        json.dump(json_data, json_file, indent=4)

    print("Data successfully saved to cricketstandings.json")
else:
