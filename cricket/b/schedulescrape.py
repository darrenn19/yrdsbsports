# Tier 1 Varsity Boys Cricket Schedule
import requests
...
def scrape_schedule():
    url = "http://yraa.com/src/schedule.php?division=64"  # Schedule over next 7 days
    ...
    # Save JSON
    with open("cricket/b/schedule.json", "w", encoding="utf-8") as f:
        json.dump({"schedule": schedule}, f, indent=4, ensure_ascii=False)

    print(f"Saved {len(schedule)} entries to cricket/b/schedule.json")
