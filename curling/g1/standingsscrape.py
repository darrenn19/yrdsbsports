#Tier 1 Varsity Girls Curling Standings
import requests
from bs4 import BeautifulSoup
import json

# URL of the standings page
url = "http://yraa.com/src/standings.php?division=73"
...
if response.status_code == 200:
    ...
    headers = ["Team", "W", "L", "ML", "T", "PTS", "EW", "EL", "PF", "PA", "DIFF"]
    ...
    with open("curling/g1/curlingg1standings.json", "w") as json_file:
        json.dump(json_data, json_file, indent=4)

    print("Data successfully saved to curlingg1standings.json")
else:
