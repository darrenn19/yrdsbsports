#Tier 1 Varsity Boys Curling Standings
import requests
from bs4 import BeautifulSoup
import json

# URL of the standings page
url = "http://yraa.com/src/standings.php?division=72"
...
if response.status_code == 200:
    ...
    with open("curling/b1/curlingb1standings.json", "w") as json_file:
        json.dump(json_data, json_file, indent=4)

    print("Data successfully saved to curlingb1standings.json")
else:
