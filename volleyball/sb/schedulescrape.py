# Tier 1 Senior Boys Volleyball Schedule
import requests
...
def scrape_schedule():
    url = "http://yraa.com/src/schedule.php?division=50"  # Schedule over next 7 days
    ...
    # Save JSON
    with open("volleyball/sb/sbschedule.json", "w", encoding="utf-8") as f:
        json.dump({"schedule": schedule}, f, indent=4, ensure_ascii=False)

    print(f"Saved {len(schedule)} entries to volleyball/sb/sbschedule.json")
