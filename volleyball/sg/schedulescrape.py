# Tier 1 Senior Girls Volleyball Schedule
import requests
...
def scrape_schedule():
    url = "http://yraa.com/src/schedule.php?division=79"  # Schedule over next 7 days
    ...
    # Save JSON
    with open("volleyball/sg/sgschedule.json", "w", encoding="utf-8") as f:
        json.dump({"schedule": schedule}, f, indent=4, ensure_ascii=False)

    print(f"Saved {len(schedule)} entries to volleyball/sg/sgschedule.json")
