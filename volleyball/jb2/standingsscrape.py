#Tier 2 Junior Boys Volleyball Standings
import requests
from bs4 import BeautifulSoup
import json

# URL of the standings page
url = "http://yraa.com/src/standings.php?division=56"
...
if response.status_code == 200:
    ...
    with open("volleyball/jb2/volleyballjb2standings.json", "w") as json_file:
        json.dump(json_data, json_file, indent=4)

    print("Data successfully saved to volleyballjb2standings.json")
else:
