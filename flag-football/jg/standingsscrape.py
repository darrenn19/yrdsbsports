#Tier 1 Junior Girls Flag Football Standings
import requests
from bs4 import BeautifulSoup
import json

# URL of the standings page
url = "http://yraa.com/src/standings.php?division=151"
...
if response.status_code == 200:
    ...
    with open("flag-football/jg/flagjgstandings.json", "w") as json_file:
        json.dump(json_data, json_file, indent=4)

    print("Data successfully saved to flagjgstandings.json")
else:
