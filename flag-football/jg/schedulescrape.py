# Tier 1 Junior Girls Flag Football Schedule
import requests
...
def scrape_schedule():
    url = "http://yraa.com/src/schedule.php?division=151"  # Schedule over next 7 days
    ...
    # Save JSON
    with open("flag-football/jg/jgschedule.json", "w", encoding="utf-8") as f:
        json.dump({"schedule": schedule}, f, indent=4, ensure_ascii=False)

    print(f"Saved {len(schedule)} entries to flag-football/jg/jgschedule.json")
