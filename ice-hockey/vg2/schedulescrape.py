# Tier 2 Varsity Girls Ice Hockey Schedule
import requests
...
def scrape_schedule():
    url = "http://yraa.com/src/schedule.php?division=70"  # Schedule over next 7 days
    ...
    # Save JSON
    with open("ice-hockey/vg2/vg2schedule.json", "w", encoding="utf-8") as f:
        json.dump({"schedule": schedule}, f, indent=4, ensure_ascii=False)

    print(f"Saved {len(schedule)} entries to ice-hockey/vg2/vg2schedule.json")
