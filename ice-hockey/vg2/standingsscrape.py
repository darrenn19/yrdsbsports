#Tier 2 Varsity Girls Ice Hockey Standings
import requests
from bs4 import BeautifulSoup
import json

# URL of the standings page
url = "http://yraa.com/src/standings.php?division=70"
...
if response.status_code == 200:
    ...
    with open("ice-hockey/vg2/icehockeyvg2standings.json", "w") as json_file:
        json.dump(json_data, json_file, indent=4)

    print("Data successfully saved to icehockeyvg2standings.json")
else:
