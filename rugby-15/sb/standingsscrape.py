#Tier 1 Senior Boys Rugby 15's Standings
import requests
from bs4 import BeautifulSoup
import json

# URL of the standings page
url = "http://yraa.com/src/standings.php?division=104"
...
if response.status_code == 200:
    ...
    with open("rugby-15/sb/rugbysbstandings.json", "w") as json_file:
        json.dump(json_data, json_file, indent=4)

    print("Data successfully saved to rugbysbstandings.json")
else:
