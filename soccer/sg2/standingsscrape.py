#Tier 2 Senior Girls Soccer Standings
import requests
from bs4 import BeautifulSoup
import json

# URL of the standings page
url = "http://yraa.com/src/standings.php?division=110"
...
if response.status_code == 200:
    ...
    with open("soccer/sg2/soccersg2standings.json", "w") as json_file:
        json.dump(json_data, json_file, indent=4)

    print("Data successfully saved to soccersg2standings.json")
else:
