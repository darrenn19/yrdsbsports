# Tier 1 Senior Girls Soccer Schedule
import requests
...
def scrape_schedule():
    url = "http://yraa.com/src/schedule.php?division=92"  # Schedule over next 7 days
    ...
    # Save JSON
    with open("soccer/sg1/sg1schedule.json", "w", encoding="utf-8") as f:
        json.dump({"schedule": schedule}, f, indent=4, ensure_ascii=False)

    print(f"Saved {len(schedule)} entries to soccer/sg1/sg1schedule.json")
