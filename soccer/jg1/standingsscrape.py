#Tier 1 Junior Girls Soccer Standings
import requests
from bs4 import BeautifulSoup
import json

# URL of the standings page
url = "http://yraa.com/src/standings.php?division=91"
...
if response.status_code == 200:
    ...
    with open("soccer/jg1/soccerjg1standings.json", "w") as json_file:
        json.dump(json_data, json_file, indent=4)

    print("Data successfully saved to soccerjg1standings.json")
else:
