# Tier 1 Junior Girls Soccer Schedule
import requests
...
def scrape_schedule():
    url = "http://yraa.com/src/schedule.php?division=91"  # Schedule over next 7 days
    ...
    # Save JSON
    with open("soccer/jg1/jg1schedule.json", "w", encoding="utf-8") as f:
        json.dump({"schedule": schedule}, f, indent=4, ensure_ascii=False)

    print(f"Saved {len(schedule)} entries to soccer/jg1/jg1schedule.json")
