# Tier 2 Junior Boys Soccer Schedule
import requests
...
def scrape_schedule():
    url = "http://yraa.com/src/schedule.php?division=63"  # Schedule over next 7 days
    ...
    # Save JSON
    with open("soccer/jb2/jb2schedule.json", "w", encoding="utf-8") as f:
        json.dump({"schedule": schedule}, f, indent=4, ensure_ascii=False)

    print(f"Saved {len(schedule)} entries to soccer/jb2/jb2schedule.json")
