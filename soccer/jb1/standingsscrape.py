#Tier 1 Junior Boys Soccer Standings
import requests
from bs4 import BeautifulSoup
import json

# URL of the standings page
url = "http://yraa.com/src/standings.php?division=45"
...
if response.status_code == 200:
    ...
    with open("soccer/jb1/soccerjb1standings.json", "w") as json_file:
        json.dump(json_data, json_file, indent=4)

    print("Data successfully saved to soccerjb1standings.json")
else:
